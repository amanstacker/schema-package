...
function smpg_get_schema_properties( $schema_id, $post_id = null, $tag_id = null, $user_id = null ) {
    ...
    $handlers = [
        ...
        'airline'                 => 'smpg_schema_organization',
        'consortium'              => 'smpg_schema_organization',
        'corporation'             => 'smpg_schema_organization',
        'educationalorganization' => 'smpg_schema_organization',
        'school'                  => 'smpg_schema_organization',
        'governmentorganization'  => 'smpg_schema_organization',
        'librarysystem'           => 'smpg_schema_organization',
        'newsmediaorganization'   => 'smpg_schema_organization',
        'ngo'                     => 'smpg_schema_organization',
        'performinggroup'         => 'smpg_schema_organization',
        'sportsorganization'      => 'smpg_schema_organization',
        'workersunion'            => 'smpg_schema_organization',        
